# Bellatores — Site du serveur RP Discord

Site statique (HTML/CSS/JS, aucune dépendance) présentant le serveur roleplay Discord Bellatores.

## Structure
- `index.html` — Accueil
- `lore.html` — Histoire du monde
...
Voir les instructions fournies avec ce site, ou Settings > Pages une fois le repo en ligne.
